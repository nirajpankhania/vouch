...
- README demo uses real captured agent output (the same-diff/opposite-verdict contrast) over a synthetic example: authenticity is the whole pitch; `docs/demo.tape` records the fast key-free path for a snappy GIF.
